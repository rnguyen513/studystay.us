...
import { Search, Globe, Menu, User, Heart, X, Star, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-white text-black text-xl">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center mb-8">
          <form onSubmit={handleSearch} className="hidden md:flex items-center shadow-md rounded-full border max-w-5xl w-full">
        ...
        <div className="flex items-start justify-between content-center mb-8">
          <div className="relative flex-grow overflow-hidden mr-4">
            <div className="flex space-x-8 overflow-x-auto pb-4 px-4 md:px-8 categories-scroll">
              {[
                {text:'Amazing views',thumbnail:"/placeholder.svg?height=24&width=24"},
                {text:'Icons',thumbnail:"/placeholder.svg?height=24&width=24"},
                {text:'Cabins',thumbnail:"/placeholder.svg?height=24&width=24"},
                {text:'Treehouses',thumbnail:"/placeholder.svg?height=24&width=24"},
                {text:'Earth homes',thumbnail:"/placeholder.svg?height=24&width=24"},
              ].map((label, index) => (
      ...
      {showMap && (
        <div className="fixed inset-0 z-50 bg-white">
          ...
          <div>
            <img src="/placeholder.svg?height=600&width=800&text=Map" alt="Placeholder map" className="w-full h-full object-cover" />
          </div>
        </div>
      )}
    </div>
