...
-- Allow authenticated users to upload profile pictures (simplified policy)
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view their own profile data" ON public.public_user_data;
DROP POLICY IF EXISTS "Users can insert their own profile data" ON public.public_user_data;
DROP POLICY IF EXISTS "Users can update their own profile data" ON public.public_user_data;
DROP POLICY IF EXISTS "Public read access to profile data" ON public.public_user_data;
